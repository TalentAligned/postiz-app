    ...
    return (
      <div className="flex flex-1 items-center justify-center text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-[20%] left-[10%] w-[300px] h-[300px] bg-[#9114F6] rounded-full blur-[120px]" />
          <div className="absolute bottom-[20%] right-[10%] w-[250px] h-[250px] bg-[#00C6FF] rounded-full blur-[120px]" />
        </div>
        <div className="relative z-10 text-center">
          ...
          <div className="mt-[32px] flex justify-center">
            <div className="w-[48px] h-[48px] border-[3px] border-[#9114F6] border-t-transparent rounded-full animate-spin" />
          </div>
        </div>
      </div>
    );
        ...
        <div className="bg-[#1A1919] rounded-[16px] p-[32px] flex flex-col gap-[24px]">
          ...
          <div className="flex gap-[12px]">
            <button
              ...
              disabled={submitting}
              className="flex-1 bg-[#9114F6] hover:bg-[#843CFF] disabled:opacity-50 text-white rounded-[8px] py-[10px] px-[16px] text-[14px] font-semibold transition-colors"
            >
              Authorize
            </button>
            <button
